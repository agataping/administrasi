    ...
    <div class="card w-100" style="background-color:rgba(255, 255, 255, 0.96);">
        <div class="card-body">
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-sm-">
                        <a href="/formpicahse" class="btn btn-custom">Add data </a>
                    </div>
                </div>
                {{-- @if(auth()->user()->role === 'admin')

                <form method="GET" action="{{ route('picahse') }}" id="filterForm">
                ...
                @endif
                --}}
                <form method="GET" action="{{ route('picahse') }}" style="display: flex; align-items: center; gap: 10px; margin-bottom: 20px;">
                    <div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;" rowspan="">
                                    <form action="{{ route('formupdatepicahse', ['id' => $d->id]) }}">
                                        <button type="submit" class="btn btn-primary btn-sm">Edit</button>
                                    </form>
                                </td>
                                <td style="text-align: center; vertical-align: middle;" rowspan="">
                                    <form action="{{ route('deletepicahse', $d->id) }}" method="POST" onsubmit="return confirmDelete(event)">
                                        @csrf
                                        @method('DELETE')
