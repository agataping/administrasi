...
@section('title', 'CSUpdate Pembebasan Lahan')
...
<div class="container-fluid mt-4">
    <div class="card w-100">
        <div class="card-body">
            <div class="col-12">
                <h2 class="mb-3">Cs Update Pembebasan Lahan</h2>
                ...
                <form action="{{ route('updatePembebasanLahan', $pembebasanLahanCs->id) }}" method="post">
                    @csrf
