...
@section('title', 'CS pembebasanlahan')
@section('content')
...
<div class="container-fluid mt-4">
    <div class="card w-100">
        <div class="card-body">
            <div class="col-12">
                <h2 class="mb-3">CS Pembebasan Lahan</h2>
                @if (session('success'))
                ...
                <div class="row">
                    <div class="col-sm-">
                        <a href="/formlahanCs" class="btn btn-custom">Add Pembebasan Lahan</a>
                    </div>
                </div> 
                ...
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        <form method="GET" action="{{ url('/indexPembebasanLahanCs') }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle;" >
                                <a href="{{ route('formUpdatelahanCs', ['id' => $d->id]) }}" class="btn btn-primary btn-sm">
                                    Edit
                                </a>
                            </td>
