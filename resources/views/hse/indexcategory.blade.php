        ...
        <div class="card-body">
            <div class="col-12">
                <a href="/indexhse" class=" text-decoration-none " style="color: black;">
                    <h3 class="mb-3">Description Data</h3>
                </a>
                @if (session('success'))
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;" rowspan="">
                                        <a href="{{ route('formupdatecategoryhse', ['id' => $d->id]) }}" class="btn btn-primary btn-sm">
                                            Edit
                                        </a>
                                    </td>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;" rowspan="">
                                        ...
                                        <form action="{{ route('deletecategoryhse', ['id' => $d->id]) }}" method="POST" onsubmit="return confirmDelete(event)">
