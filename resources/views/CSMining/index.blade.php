    ...
    <div class="card w-100">
        <div class="card-body">
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-sm-">
                        <a href="/FormKategoriCsMining" class="btn btn-custom">Add Cs Kategori</a>
                    </div>
                </div> 
                <div class="row">
                    <div class="col-sm-">
                        <a href="/FormCsMining" class="btn btn-custom">Add Cs Mining Readines</a>
                    </div>
                </div> 
                ...
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        <form method="GET" action="{{ url('/indexCSmining') }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle;" >
                                <a href="{{ route('FormCsupdateMining', ['id' => $d->id]) }}" class="btn btn-primary btn-sm">
                                    Edit
                                </a>
                            </td>
