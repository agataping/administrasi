            ...
            <div class="col-12">
                ...
                <div class="row mt-1">
                    <div class="col-2 d-flex justify-content-center align-items-center" style="background-color: #f4e2cd; font-size: 2em;
                        @if ($totalresultfinancial<= 75)background-color: black; color: white;
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 5px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle; 
                                            ...
                                            background-color: blue; color: white; /* Hijau */
                                            @endif"> 
                                            {{ number_format($indexcostemlpoye, 2) }}%
                                        </td>
                                    </tr>
                            ...
                            <table class="table table-bordered" style="border: 1px solid black; border-collapse: collapse; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Actual</td>
                                        <td class="text-end">{{ number_format($totalvertikals, 2) }}%</td>
                                    </tr>
                                    <tr>
                                        <td>Index</td>
                                        <td style="vertical-align: middle; 
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle; 
                                            ...
                                            background-color: rgb(206, 24, 24); color: white; /* Merah */                                                            @elseif ($indexactualasset > 90 && $indexactualasset <= 100)
                                            background-color: yellow; color: black; /* Kuning */
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end" style="vertical-align: middle; 
                                        ...
                                        @elseif ($indexoverburder > 190)
                                        background-color: rgb(0, 42, 255); color: white;
                                        @endif">{{ number_format($item['indexpa'], 0, ',', '.') }}%
                                    </td>
                                </tr>
                                <tr>
                                    <td>Weight</td>
                                    ...
                                    <td>{{ number_format($totalpr, 0, ',', '.') }}%</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end" style="
                                                ...
                                                background-color: rgb(0, 60, 255); color: white;
                                                @endif">{{ number_format($indexpeople, 0, ',', '.') }}%
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Weight</td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end" style="
                                                    ...
                                                    background-color: rgb(0, 60, 255); color: white;
                                                    @endif">{{ number_format($indexinfra, 0, ',', '.') }}%
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Weight</td>
