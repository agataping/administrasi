    ...
    <div class="card w-100" style="background-color:rgba(255, 255, 255, 0.96);">
        <div class="card-body">
            <div class="col-12">
                ...
                <form method="GET" action="{{ route('indexproduksiua') }}" id="filterForm">
                ...
                @endif --}}
                <form method="GET" action="{{ route('indexproduksiua') }}" style="display: flex; align-items: center; gap: 10px; margin-bottom: 20px;">
                    <div>
                    ...
                    <table id="myTable" class="table table-bordered" style="border: 2px solid gray; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.51);">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;" rowspan="">
                                    <form action="{{ route('deleteproduksiua', $detail->id) }}" method="POST" onsubmit="return confirmDelete(event)">
                                        @csrf
                                        @method('DELETE')
