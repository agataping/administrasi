    ...
    <div class="card w-100" style="background-color:rgba(255, 255, 255, 0.96);">
        <div class="card-body">
            <div class="col-12">
                ...
                <h3 class="mb-3" onclick="window.history.back()" style="cursor: pointer;">Unit Data</h3>
                        ...
                        <table id="mytTable" class="table table-bordered" style="border: 2px solid gray; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.51);">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: ;">{{$d->unit}}</td>

                                    <td style="text-align: center; vertical-align: middle;" rowspan="">
                                        <a href="{{ route('formupadteunit', ['id' => $d->id]) }}" class="btn btn-primary btn-sm">
                                            Edit
                                        </a>
                                    </td>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;" rowspan="">
                                        ...
                                        <form action="{{ route('deleteunit', ['id' => $d->id]) }}" method="POST" onsubmit="return confirmDelete(event)">
