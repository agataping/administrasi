...
<div class="container-fluid mt-2">
    <div class="card w-100" style="background-color:rgba(255, 255, 255, 0.96);">
        <div class="card-body">
            <div class="col-12">
                <h3 class="mb-3">PICA Land Acquissition</h3>
{{-- Error Notification --}}
@if ($errors->any())
...
@endif
                <div class="row">
                    <div class="col-sm-">
                        <a href="/formpicapl" class="btn btn-custom">Add data </a>
                    </div>
                </div>
                <!-- @if(auth()->user()->role === 'admin')

                <form method="GET" action="{{ route('picapl') }}" id="filterForm">
                ...
                <form method="GET" action="{{ route('picapl') }}" style="display: flex; align-items: center; gap: 10px; margin-bottom: 20px;">
                        <div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;" rowspan="">
                                    <form action="{{ route('formupdatepicapl', ['id' => $d->id]) }}">
                                        <button type="submit" class="btn btn-primary btn-sm">Edit</button>
                                    </form>
                                </td>
                                <td style="text-align: center; vertical-align: middle;" rowspan="">
                                    <form action="{{ route('deletepicapl', $d->id) }}" method="POST" onsubmit="return confirmDelete(event)">
                                        @csrf
                                        @method('DELETE')
