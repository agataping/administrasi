            ...
            <div class="col-12">
                ...
                <form method="GET" action="{{ route('indexcoal') }}" id="filterForm">
                    <label for="id_company">Select Company:
                        <br>
                        <small><em>To view company data, please select a company from the list.</em></small></label> </label>
                    ...
                    <table id="myTable" class="table table-bordered" style="border: 2px solid gray; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.51);">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle; text-align: end;">{{ is_numeric($detail->nominalactual ) ? number_format((float)$detail->nominalactual , 2, ',', '.') : '0,00' }}</td>
                                <td></td>
                                <td></td>
