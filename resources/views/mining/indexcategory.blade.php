                        ...
                        <table class="table table-bordered" style="border: 2px solid gray; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.51);">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: ;">{{$d->kategori}}</td>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;" rowspan="">
                                        ...
                                        <form action="{{ route('deletecategorymining', ['id' => $d->id]) }}" method="POST" onsubmit="return confirmDelete(event)">
