    ...
    <div class="card w-100">
        <div class="card-body">
            <div class="col-12">
                ...
                <h2 class="mb-3">Update Data Category Meaning Readines</h2>
                </a>                
                ...
                @endif
                <form action="{{ route('updatecategorymining',$data->id) }}" method="post">
                @csrf
                ...
                <div id="">
                    <div class="row g-3">
                        <div class="">
                            ...
                            <input type="text" class="form-control" id="kategori" placeholder="e.g. Legalitas, Lingkungan Penjualan Etc." value="{{$data->kategori}}" required name="kategori">
                        </div>
                    </div>
                </div>
