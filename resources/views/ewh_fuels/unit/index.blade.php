        ...
        <div class="card-body">
            <div class="col-12">
                ...
                <a href="/indexewh" class=" text-decoration-none " style="color: black;">
                    <h3 class="mb-3">Unit code Data</h3>
                </a>
                ...
                <div class="" style="overflow-x:auto;">
                    <div class="table-responsive" style="max-height: 400px; overflow-y:auto;">
                        <table id="mytTable" class="table table-bordered" style="border: 2px solid gray; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.51);">
                            <thead style=" position: sticky; top: 0; z-index: 1; background-color:rgba(9, 220, 37, 0.75); text-align: center; vertical-align: middle;">
                                <tr>
                                    ...
                                    <th rowspan="2" style="vertical-align: middle;">Unit Code</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: ;">{{$d->code}}</td>

                                    <td style="text-align: center; vertical-align: middle;" rowspan="">
                                        <a href="{{ route('formupdatecodeunit', ['id' => $d->id]) }}" class="btn btn-primary btn-sm">
                                            Edit
                                        </a>
                                    </td>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;" rowspan="">
                                        ...
                                        <form action="{{ route('deletedcodeunit', ['id' => $d->id]) }}" method="POST" onsubmit="return confirmDelete(event)">
