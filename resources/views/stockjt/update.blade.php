    ...
    <div class="card w-100">
        <div class="card-body">
            <div class="col-12">
                ...
                <form action="{{ route('updatestockjt',$data->id) }}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" valeu="{{$data->date}}" id="date" name="date" required>
                    </div>

                    <div class="form-group" id="stock" style="display: none;">
                        <label for="stock">Opening Stock</label>
                        <input type="number" class="form-control" valeu="{{$data->sotckawal}}" id="stockawal" name="sotckawal" min="" >
                    </div>

                    <div class="form-group">
                        <label for="shift_pertama">Shift I</label>
                        <input type="number" class="form-control" valeu="{{$data->shifpertama}}" id="shift_pertama" name="shifpertama" min="">
                    </div>

                    <div class="form-group">
                        <label for="shift_kedua">Shift II</label>
                        <input tBZype="number" class="form-control" valeu="{{$data->shifkedua}}" id="shift_kedua" name="shifkedua" min="0" >
                    </div>

                    <div class="form-group">
                        <label for="total_hauling">Total Hauling</label>
                        <input type="number" class="form-control" valeu="{{$data->totalhauling}}" id="total_hauling" name="totalhauling" min="0" readonly>
                    </div>
                    <div class="form-group">
                        <label for="Lokasi">Location</label>
                        <input type="text" class="form-control" valeu="{{$data->lokasi}}" id="Lokasi" name="lokasi" >
                    </div>
