...
<div class="container-fluid mt-4">
    <div class="card w-100">
        <div class="card-body">
            <div class="col-12">
                <h2 class="mb-3">Pica Keuangan </h2>
                @if (session('success'))
                ...
                <div class="row">
                    <div class="col-sm-">
                        <a href="/formpicalr" class="btn btn-custom">Add Pica </a>
                    </div>
                </div> 
                
                <form method="GET" action="{{ route('picalr') }}" style="display: flex; align-items: center; gap: 10px; margin-bottom: 20px;">
                    <div >
                    ...
                    <tbody>
                        @foreach($data as $d)
                            ...
                            <td style="text-align: center; vertical-align: middle;"  rowspan="">
                                <form action="{{ route('formupdatepicalr', ['id' => $d->id]) }}">
                                    <button type="submit"  class="btn btn-primary btn-sm">Edit</button>
                                </form>
                            </td>
                                    <td style="text-align: center; vertical-align: middle;"  rowspan="">
                                <form action="{{ route('deletepicalr', $d->id) }}" method="POST" onsubmit="return confirmDelete(event)" >
                                    @csrf
                                    @method('DELETE')
