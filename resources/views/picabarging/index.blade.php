...
@endif
                ...
                <div class="row">
                    <div class="col-sm-">
                        <a href="/formpicabarging" class="btn btn-custom">Add data </a>
                    </div>
                </div>
                ...
                <form method="GET" action="{{ route('indexpicabarging') }}" style="text-transform: uppercase;display: flex; align-items: center; gap: 10px; margin-bottom: 20px;">
                    <div>
