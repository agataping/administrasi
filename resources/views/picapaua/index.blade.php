...
@endif
                <div class="row">
                    <div class="col-sm-">
                        <a href="/formpicapaua" class="btn btn-custom">Add data</a>
                    </div>
                </div>
                <!-- @if(auth()->user()->role === 'admin')

                <form method="GET" action="{{ route('picapaua') }}" id="filterForm">
                ...
                <form method="GET" action="{{ route('picapaua') }}" style="display: flex; align-items: center; gap: 10px; margin-bottom: 20px;">
                        <div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;" rowspan="">
                                    <form action="{{ route('formupdatepicapaua', ['id' => $d->id]) }}">
                                        <button type="submit" class="btn btn-primary btn-sm">Edit</button>
                                    </form>
                                </td>
                                <td style="text-align: center; vertical-align: middle;" rowspan="">
                                    <form action="{{ route('deletepicapaua', $d->id) }}" method="POST" onsubmit="return confirmDelete(event)">
                                        @csrf
                                        @method('DELETE')
